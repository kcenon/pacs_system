...
if(PACS_WITH_CONTAINER_SYSTEM)
    ...
    if(TARGET container_system::container_system)
        set(CONTAINER_SYSTEM_FOUND TRUE)
        set(PACS_CONTAINER_SYSTEM_INCLUDE_DIR "FOUND_VIA_PACKAGE")
        if(NOT TARGET container_system)
            add_library(container_system INTERFACE IMPORTED)
            set_property(TARGET container_system PROPERTY INTERFACE_LINK_LIBRARIES container_system::container_system)
        endif()
    endif()
...
if(TARGET thread_system::thread_system)
    ...
    if(NOT TARGET thread_system)
        add_library(thread_system INTERFACE IMPORTED)
        set_property(TARGET thread_system PROPERTY INTERFACE_LINK_LIBRARIES thread_system::thread_system)
    endif()
endif()
...
if(TARGET logger_system::logger)
    ...
    if(NOT TARGET logger_system)
        add_library(logger_system INTERFACE IMPORTED)
        set_property(TARGET logger_system PROPERTY INTERFACE_LINK_LIBRARIES logger_system::logger)
    endif()
endif()
...
if(PACS_BUILD_STORAGE)
    ...
    if(TARGET database_system::database_system)
        ...
        if(NOT TARGET database)
            add_library(database INTERFACE IMPORTED)
            set_property(TARGET database PROPERTY INTERFACE_LINK_LIBRARIES database_system::database_system)
        endif()
    endif()
...
if(PACS_BUILD_STORAGE)
    ...
    if(TARGET monitoring_system::monitoring_system)
        ...
        if(NOT TARGET monitoring_system)
            add_library(monitoring_system INTERFACE IMPORTED)
            set_property(TARGET monitoring_system PROPERTY INTERFACE_LINK_LIBRARIES monitoring_system::monitoring_system)
        endif()
    endif()
...
if(PACS_WITH_NETWORK_SYSTEM)
    ...
    if(TARGET network_system::network_system)
        ...
        if(NOT TARGET network_system)
            add_library(network_system INTERFACE IMPORTED)
            set_property(TARGET network_system PROPERTY INTERFACE_LINK_LIBRARIES network_system::network_system)
        endif()
    endif()
