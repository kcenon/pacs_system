...
public:
    ...
    [[nodiscard]] codec_result encode(std::span<const uint8_t> pixel_data,
        ...
        if (!image) {
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to create OpenJPEG image structure");
        }
        ...
        for (uint16_t c = 0; c < params.samples_per_pixel; ++c) {
            ...
            for (size_t i = 0; i < pixel_count; ++i) {
                ...
                if (src_idx + bytes_per_sample > pixel_data.size()) {
                    ...
                    return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Pixel data buffer too small");
                }
        ...
        if (!codec) {
            opj_image_destroy(image);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to create OpenJPEG encoder");
        }
        ...
        if (!opj_setup_encoder(codec, &parameters, image)) {
            ...
            opj_image_destroy(image);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to setup OpenJPEG encoder: " + error_msg);
        }
        ...
        if (!stream) {
            opj_destroy_codec(codec);
            opj_image_destroy(image);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to create OpenJPEG output stream");
        }
        ...
        if (!opj_start_compress(codec, image, stream)) {
            ...
            opj_destroy_codec(codec);
            opj_image_destroy(image);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to start JPEG 2000 encoding: " + error_msg);
        }
        ...
        if (!opj_encode(codec, stream)) {
            ...
            opj_destroy_codec(codec);
            opj_image_destroy(image);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to encode JPEG 2000 data: " + error_msg);
        }
        ...
        if (!opj_end_compress(codec, stream)) {
            ...
            opj_destroy_codec(codec);
            opj_image_destroy(image);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to finalize JPEG 2000 encoding: " + error_msg);
        }
        ...
        return kcenon::pacs::ok<compression_result>(compression_result{std::move(output_buf.data), params});
#endif  // PACS_WITH_JPEG2000_CODEC
    }
    ...
    [[nodiscard]] codec_result decode(std::span<const uint8_t> compressed_data,
        ...
        if (!codec) {
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to create OpenJPEG decoder");
        }
        ...
        if (!opj_setup_decoder(codec, &parameters)) {
            opj_destroy_codec(codec);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to setup OpenJPEG decoder: " + error_msg);
        }
        ...
        if (!stream) {
            opj_destroy_codec(codec);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to create OpenJPEG input stream");
        }
        ...
        if (!opj_read_header(stream, codec, &image)) {
            opj_stream_destroy(stream);
            opj_destroy_codec(codec);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to read JPEG 2000 header: " + error_msg);
        }
        ...
        if (!opj_decode(codec, stream, image)) {
            ...
            opj_stream_destroy(stream);
            opj_destroy_codec(codec);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to decode JPEG 2000 data: " + error_msg);
        }
        ...
        if (!opj_end_decompress(codec, stream)) {
            ...
            opj_stream_destroy(stream);
            opj_destroy_codec(codec);
            return kcenon::pacs::pacs_error<compression_result>(kcenon::pacs::error_codes::decompression_error, "Failed to finalize JPEG 2000 decoding: " + error_msg);
        }
        ...
        return kcenon::pacs::ok<compression_result>(compression_result{std::move(output_data), output_params});
#endif  // PACS_WITH_JPEG2000_CODEC
    }
