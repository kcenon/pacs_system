...
> **단계 정의**: 공식 단계 정의는 [PRD Development Phases](PRD.md#development-phases)를 참조하세요. 아래 기능 섹션은 다음과 같이 단계에 대응됩니다:
> - **Phase 1** (완료): DICOM 코어 기능
...
| 기능 | 설명 | 완료 단계 |
|------|------|-----------|
| ~~추가 SOP 클래스 (PET/NM)~~ | NM, PET 지원 | Phase 4 ✅ |
| ~~추가 SOP 클래스 (RT)~~ | RT 계획, RT 구조 세트 등 | Phase 4 ✅ |
